...
class KernelArgs:
    ...
    def cpp_argdefs(self):
        from torch._inductor.codegen.cpp import DTYPE_TO_CPP, INDEX_TYPE
...
class CppWrapperKernelArgs(KernelArgs):
    def wrap_ptr_arg(self, buf, dtype):
        from torch._inductor.codegen.cpp import DTYPE_TO_CPP
...
class LLVM_Kernel(CodeGen):
    ...
    def __init__(self, args=None):
        ...
        self.compute = IndentedBuffer()
        self.stores = IndentedBuffer()
        self.cse = CSE(self.newvar_prefix, self.suffix, self.name_prefix)
        self.must_keep_buffers = set()
        self.store_buffer_names = set()
        # set in set_current_node
        self.current_node = None
